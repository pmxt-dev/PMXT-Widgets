...
export function TimelineChart({ width, height, selectedFilter = 'all', theme = 'light', showShadow = false }: TimelineChartProps) {
          ...
          <g style={{ pointerEvents: 'none' }}>
            ...
            <g transform={`translate(${hoveredIndex > numPoints / 2 ? hoveredIndex * barWidth - 175 : hoveredIndex * barWidth + barWidth + 10}, 10)`}>
              ...
              <rect
                ...
                height={100}
                fill={isDark ? "#111" : "#000"}
                stroke={isDark ? "#333" : "rgba(255,255,255,0.2)"}
                strokeWidth={1}
              />
